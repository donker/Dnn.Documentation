...
2.  Click/Tap Create Content, then select the type for this content item.
...
3.  Fill in the fields of the content item.
...
4.  In the Properties tab, configure the properties of the content item.
...
5.  In the SEO tab, configure the SEO for the content item.
...
6.  Close, save as draft, or save as completed.
