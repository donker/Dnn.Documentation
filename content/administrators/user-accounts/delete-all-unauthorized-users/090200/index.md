...
3.  For each user to delete, click/tap the ellipses icon, then choose Delete User.
    ...
    ![User List > find the user > ellipses icon > Delete User](img/scr-UserList-ellipsesmenu-DeleteUser-E90.png)
